...
<?php foreach ($wisata as $i) : ?>
    <div id="page_caption" class="hasbg parallax" style="background-image:url(<?= base_url('public/upload/image/wisata/header/'); ?><?= $i['header']; ?>);">
        <div class="single_tour_header_content">
            <div class="standard_wrapper">
                <a href="<?= base_url('public/upload/image/wisata/header/'); ?><?= $i['header']; ?>" id="single_tour_gallery_open" class="button fancy-gallery"><span class="ti-camera"></span>Lihat Foto</a>
                <div style="display:none;">
                    <a id="single_tour_gallery_image1" href="<?= base_url('public/upload/image/wisata/destinasi1/'); ?><?= $i['destinasi1']; ?>" title="<?= $i['nama']; ?>" class="fancy-gallery"></a>
                    <a id="single_tour_gallery_image2" href="<?= base_url('public/upload/image/wisata/destinasi2/'); ?><?= $i['destinasi2']; ?>" title="<?= $i['nama']; ?>" class="fancy-gallery"></a>
                    <a id="single_tour_gallery_image3" href="<?= base_url('public/upload/image/wisata/destinasi3/'); ?><?= $i['destinasi3']; ?>" title="<?= $i['nama']; ?>" class="fancy-gallery"></a>
                    <a id="single_tour_gallery_image4" href="<?= base_url('public/upload/image/wisata/'); ?><?= $i['thumbnail']; ?>" title="<?= $i['nama']; ?>" class="fancy-gallery"></a>
                </div>
    ...
    <div id="page_content_wrapper" class="hasbg ">
        <div class="inner">
            ...
            <div class="inner_wrapper">
                                            ...
                                            <p>
                                                <label> Jumlah Pesan Tiket
                                                    ...
                                                    <span class="wpcf7-form-control-wrap text-237">
                                                        ...
                                                        <input type="hidden" id="nama_wisata" name="nama_wisata" value="<?= $i['nama']; ?>">
                ...
                <div class="sidebar_content ">
                    ...
                    <div class="single_tour_content">
                        ...
                        <div id="attachment_48" style="width: 1034px" class="wp-caption alignnone"><img class="wp-image-48 size-large" src="<?= base_url('public/upload/image/wisata/header/'); ?><?= $i['header']; ?>" width="1024" />
                            <p class="wp-caption-text">Foto destinasi wisata <?= $i['nama']; ?>.</p>
                        </div>
                        <div id="attachment_48" style="width: 1034px" class="wp-caption alignnone"><img class="wp-image-48 size-large" src="<?= base_url('public/upload/image/wisata/destinasi1/'); ?><?= $i['destinasi1']; ?>" width="1024" />
                            <p class="wp-caption-text">Foto destinasi wisata <?= $i['nama']; ?>.</p>
                        </div>
                        <div id="attachment_48" style="width: 1034px" class="wp-caption alignnone"><img class="wp-image-48 size-large" src="<?= base_url('public/upload/image/wisata/destinasi2/'); ?><?= $i['destinasi2']; ?>" width="1024" />
                            <p class="wp-caption-text">Foto destinasi wisata <?= $i['nama']; ?>.</p>
                        </div>
                        <div id="attachment_48" style="width: 1034px" class="wp-caption alignnone"><img class="wp-image-48 size-large" src="<?= base_url('public/upload/image/wisata/destinasi3/'); ?><?= $i['destinasi3']; ?>" width="1024" />
                            <p class="wp-caption-text">Foto destinasi wisata <?= $i['nama']; ?>.</p>
                        </div>
                    </div>
                    ...
                    <ul class="single_tour_departure_wrapper themeborder">
                        <li>
                            <div class="single_tour_departure_title">Nama Wisata</div>
            ...
            <div class="tour_related">
                <h3 class="sub_title">Destinasi Wisata Lainnya</h3>
