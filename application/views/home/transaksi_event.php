                    ...
                    <div id="portfolio_filter_wrapper" class="gallery classic two_cols portfolio-content section content clearfix" data-columns="3">
                        ...
                        <?php foreach ($transaksi as $d) { ?>
                            <div class="tour_list_wrapper floatleft">
                                <div class="one_third">
                                    <a class="tour_image" href="<?= base_url('Home/detail_event/') . $d->id_event; ?>">
                                        <img src="<?= base_url('public/upload/image/event/'); ?><?= $d->thumbnail; ?>" alt="<?= $d->nama_event; ?>" />
                                    </a>
                                </div>
                                ...
                                <div class="two_third last">
                                    ...
                                    <div class="tour_list_excerpt">
                                        Tiket Event <?= $d->nama_event; ?> </br><?= $d->jumlah; ?> Tiket x Rp.<?= number_format($d->harga, '0', '', '.'); ?> </div>
                                    <div class="tour_list_excerpt">
                                    ...
                                    <div class="tour_attribute_wrapper">
                                        ...
                                        <div class="tour_attribute_days">
                                            ...
                                            ?>
                                                <?php
                                                $check = $this->templates->query("SELECT * FROM rating_event WHERE order_id = $d->order_id");
                                                if ($check->num_rows() > 0) {
                                                ?>

                                                    <a href="<?php echo base_url(); ?>home/edit_ulasan_event/<?php echo $d->order_id; ?>" class="button small left" style="background-color:#cb5f54 !important;color:#ffffff !important;border:1px solid #cb5f54 !important;margin-right:10px;margin-bottom:10px;">Edit Ulasan</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table>
                        ...
                        <tr>
                            <td>Item</td>
                            <td>:</td>
                            <td>Tiket Event <?= $d->nama_event; ?> x <?= $d->jumlah; ?></td>
                        </tr>
                        <tr>
                            <td>Harga</td>
                            <td>:</td>
                ...
                <div class="modal-footer">
                    <a target="_blank" href="<?= base_url('Home/invoice_event/') . $d->order_id; ?>" class="button small left" style="background-color:#cb5f54 !important;color:#ffffff !important;border:1px solid #cb5f54 !important;margin-right:10px;margin-bottom:10px;">Cetak Invoice</a>
	...
	<div class="modal fade" id="selesaikan<?= $d->order_id; ?>" tabindex="-1" role="dialog" aria-labelledby="selesaikanLabel<?= $d->order_id; ?>" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="<?= base_url('Home/status_event/') . $d->order_id; ?>" class="button small left" style="background-color:#cb5f54 !important;color:#ffffff !important;border:1px solid #cb5f54 !important;margin-right:10px;margin-bottom:10px;">Selesaikan</a>
					<button type="button" class="button small left" style="background-color:#97a2a2 !important;color:#ffffff !important;border:1px solid #97a2a2 !important;margin-right:10px;margin-bottom:10px;" data-dismiss="modal">Close</button>
				</div>
			</div>
		</div>
