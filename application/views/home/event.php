                    ...
                    <div class="content">
                        ...
                        <ul class="sidebar_widget">
                            <li id="grandtour_tour_posts-2" class="widget Grandtour_Tour_Posts">
                                <h2 class="widgettitle">Wisata Terbaru</h2>
                                <?php
                                foreach (array_chunk($wisata->result(), 1) as $entriesRow) {
                                    echo '<div>';
                                    foreach ($entriesRow as $row) {
                                ?>
                                        <div class="one gallery1 grid static filterable portfolio_type themeborder" style="background-image:url(<?= base_url('public/upload/image/wisata/'); ?><?= $row->thumbnail; ?>);">
