                                ...
                                <tbody>
                                    <?php foreach ($transaksi as $d) { ?>
                                        ...
                                        <tr class="noBorder">
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td style="text-align: right; margin-right: 0px; vertical-align: middle"><button type="button" style="border: none; padding: 0; background: none;" data-toggle="modal" data-target="#detailTransaksi<?= $d->order_id; ?>">Lihat Detail Transaksi</button></td>
                                            <?php
                                            if ($d->status_code == "200") {
                                            ?>
