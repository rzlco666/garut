...
<?php foreach ($transaksi as $d) { ?>
    <!-- Modal Ulasan -->
    <div class="modal fade" id="updateUlasan<?= $d->order_id; ?>" tabindex="-1" role="dialog" aria-labelledby="updateUlasanLabel<?= $d->order_id; ?>" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateUlasanLabel<?= $d->order_id; ?>">Update Ulasan &mdash; <?= $d->order_id; ?></h5>
